 ...
 *******************************************/
 class Tirelire{
	...
	public void remplir(double mettreArgent) {
		if(mettreArgent > 0) {
		montant += mettreArgent;
		} 			
	}
	//----------------------------------
   ...
   public void puiser(double prendreMontant) {
	   if(prendreMontant > 0 && prendreMontant < montant) {	
		   montant -= prendreMontant;
	   }
	   if (prendreMontant > montant) {
		   montant = 0.0;
	   }
   }
   //-----------------------------------------
   
   public double calculerSolde(double argentTotal) {
	   if(argentTotal > 0 ) {		   
		   return montant - argentTotal ;
